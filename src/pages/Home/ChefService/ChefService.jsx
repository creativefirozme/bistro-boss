...
const ChefService = () => {
    return (
        <div style={{ backgroundImage: `url(${chefService})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "572px", backgroundPosition: "center" }} className='mt-10 max-w-screen-xl pt-32'>
